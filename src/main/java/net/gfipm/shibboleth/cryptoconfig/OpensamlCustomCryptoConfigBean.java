...
package net.gfipm.shibboleth.cryptoconfig;
...
public class OpensamlCustomCryptoConfigBean implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (config instanceof BasicSecurityConfiguration) {
            ...
            log.info("Overriding global OpenSAML digital signature algorithm URI (RSA with SHA1) to: {}",
                    SignatureConstants.ALGO_ID_SIGNATURE_RSA_SHA256);
             secConfig.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_RSA_SHA256);					

            log.info("Overriding global OpenSAML digest method algorithm URI (SHA1) to: {}",
